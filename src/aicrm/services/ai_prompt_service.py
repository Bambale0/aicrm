...
class AIPromptService:
    ...
    def get_active_prompts(self) -> List[AIPrompt]:
        ...
        return self.db.query(AIPrompt).filter(AIPrompt.is_active == True).order_by(AIPrompt.category, AIPrompt.name).all()
    ...
    def create_prompt(self, name: str, content: str, category: str, **kwargs) -> AIPrompt:
