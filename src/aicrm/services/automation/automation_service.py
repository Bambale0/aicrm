...
class AutomationService:
    ...
    async def handle_event(
        ...
        """
        logger.info(f"Processing automation event: {entity_type.value}.{event_type.value} for entity {entity_id}")
    ...
    async def move_to_stage(
        ...
        """
        logger.info(f"Manually moving {entity_type.value} {entity_id} to stage {stage_id}")
    ...
    async def on_customer_updated(self, customer_id: int, changes: Dict[str, Any]) -> Dict[str, Any]:
        """Клиент обновлен"""
        return await self.handle_event(
            EntityType.CUSTOMER,
    ...
    async def on_customer_loyalty_changed(self, customer_id: int, old_level: str, new_level: str) -> Dict[str, Any]:
    ...
    async def on_order_status_changed(self, order_id: int, old_status: str, new_status: str) -> Dict[str, Any]:
    ...
    async def on_task_status_changed(self, task_id: int, old_status: str, new_status: str) -> Dict[str, Any]:
    ...
    async def on_deadline_approaching(self, task_id: int, hours_left: int) -> Dict[str, Any]:
    ...
    async def on_production_step_completed(self, step_id: int) -> Dict[str, Any]:
        ...
        return await self.handle_event(
            ...
            TriggerEvent.PRODUCTION_STEP_COMPLETED,
            step_id
        )
    ...
    async def on_production_overdue(self, step_id: int, overdue_hours: float) -> Dict[str, Any]:
    ...
    async def on_message_received(self, communication_id: int, entity_type: EntityType, entity_id: int) -> Dict[str, Any]:
        """Получено сообщение"""
        return await self.handle_event(
            entity_type,
    ...
    async def on_message_sent(self, communication_id: int, entity_type: EntityType, entity_id: int) -> Dict[str, Any]:
    ...
    async def on_email_opened(self, communication_id: int, entity_type: EntityType, entity_id: int) -> Dict[str, Any]:
        """Email открыт"""
        return await self.handle_event(
            entity_type,
    ...
    async def generate_automation_chain_with_ai(
        ...
        try:
            ...
            prompt = self._build_generation_prompt(description, entity_type, complexity_level)
    ...
    async def optimize_automation_chain_with_ai(
        ...
        try:
            ...
            applied_optimizations = await self._apply_optimizations(process_id, optimizations)
    ...
    async def analyze_and_suggest_improvements(
        ...
        try:
            ...
            stats = await self._collect_automation_stats(entity_type, analysis_period_days)
