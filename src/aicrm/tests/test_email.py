...
from ..services.email_service import EmailService, EmailMessage, EmailAttachment, email_service
...
class TestEmailService:
    ...
    def test_render_template_order_confirmation(self):
        ...
        html_body, text_body = self.service._render_template("order_confirmation", template_data)
    ...
    def test_render_template_task_assigned(self):
        ...
        html_body, text_body = self.service._render_template("task_assigned", template_data)
