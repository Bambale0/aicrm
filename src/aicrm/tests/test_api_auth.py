...
class TestAuthAPI:
    ...
    async def test_register_success(self, async_client: AsyncClient):
        ...
        user_data = {"email": "newuser@example.com", "password": "securepassword123"}
    ...
    async def test_login_success_form(self, async_client: AsyncClient):
        ...
        user_data = {"email": "loginform@example.com", "password": "password123"}
    ...
    async def test_login_success_json(self, async_client: AsyncClient):
        ...
        # Сначала регистрируем пользователя
        user_data = {"email": "loginjson@example.com", "password": "password123"}
        await async_client.post("/auth/register", json=user_data)
    ...
    async def test_login_case_sensitive_email(self, async_client: AsyncClient):
        ...
        user_data = {"email": "CaseSensitive@example.com", "password": "password123"}
        await async_client.post("/auth/register", json=user_data)
    ...
    async def test_login_form_encoding(self, async_client: AsyncClient):
        ...
        user_data = {"email": "formtest@example.com", "password": "formpassword123"}
        await async_client.post("/auth/register", json=user_data)
    ...
    async def test_register_special_characters_password(
