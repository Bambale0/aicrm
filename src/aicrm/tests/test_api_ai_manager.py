...
class TestAIManagerApi:
    ...
    async def test_get_prompt_by_id_success(self, async_client: AsyncClient):
        ...
        with patch(
            "src.aicrm.services.ai_prompt_service.AIPromptService"
            ...
            create_response = await async_client.post(
                "/ai-manager/prompts", json=create_data
            )
    ...
    async def test_update_prompt_success(self, async_client: AsyncClient):
        ...
        update_data = {"name": "Updated Prompt", "content": "Updated content"}
    ...
    async def test_update_prompt_not_found(self, async_client: AsyncClient):
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/prompts/999", json=update_data
            )
    ...
    async def test_get_service_by_id_success(self, async_client: AsyncClient):
        ...
        with patch(
            "src.aicrm.services.service_service.ServiceService"
        ) as mock_service_class:
            mock_service = MagicMock()
            mock_svc = MagicMock()
            mock_svc.id = 1
    ...
    async def test_update_service_success(self, async_client: AsyncClient):
        ...
        update_data = {"name": "Updated Service", "price": 1500.00}
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/services/1", json=update_data
            )
    ...
    async def test_update_service_not_found(self, async_client: AsyncClient):
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/services/999", json=update_data
            )
    ...
    async def test_get_product_by_id_success(self, async_client: AsyncClient):
        ...
        with patch(
            "src.aicrm.services.product_service.ProductService"
        ) as mock_service_class:
            mock_service = MagicMock()
    ...
    async def test_update_product_success(self, async_client: AsyncClient):
        ...
        update_data = {"name": "Updated Product", "price": 600.00}
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/products/1", json=update_data
            )
    ...
    async def test_update_product_not_found(self, async_client: AsyncClient):
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/products/999", json=update_data
            )
    ...
    async def test_update_product_stock_success(self, async_client: AsyncClient):
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/products/1/stock", json={"stock_quantity": 20}
            )
    ...
    async def test_update_product_stock_not_found(self, async_client: AsyncClient):
        ...
        with patch(
            ...
            response = await async_client.put(
                "/ai-manager/products/999/stock", json={"stock_quantity": 20}
            )
    ...
    async def test_get_low_stock_products_success(self, async_client: AsyncClient):
        ...
        with patch(
            ...
            response = await async_client.get(
                "/ai-manager/products/low-stock?threshold=5"
            )
    ...
    async def test_create_prompt_validation_error(self, async_client: AsyncClient):
        ...
        invalid_data = {"name": "", "content": "Test content"}  # Пустое имя
    ...
    async def test_create_service_validation_error(self, async_client: AsyncClient):
        ...
        invalid_data = {"name": "Test Service", "price": -100.00}  # Отрицательная цена
    ...
    async def test_update_product_stock_validation_error(
        self, async_client: AsyncClient
    ):
        """Тест валидации данных при обновлении количества товара"""
        invalid_data = {"stock_quantity": -10}  # Отрицательное количество

        response = await async_client.put(
            "/ai-manager/products/1/stock", json=invalid_data
        )
