...
class TestAutomationAPIRouter:
    ...
    def test_fire_automation_event_unit(self):
        ...
        with patch(
            "src.aicrm.api.routers.automation.AutomationService",
            return_value=mock_automation_service,
        ):
    ...
    def test_move_entity_to_stage_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.move_to_stage = AsyncMock(
        ...
        with patch(
            ...
            result = move_entity_to_stage(
                EntityType.CUSTOMER, 1, 2, mock_db, mock_current_user
            )
    ...
    def test_move_entity_to_stage_failure(self):
        ...
        with (
            ...
            move_entity_to_stage(EntityType.CUSTOMER, 1, 2, mock_db, mock_current_user)
    ...
    def test_on_customer_created_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.on_customer_created = AsyncMock(
    ...
    def test_on_order_created_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.on_order_created = AsyncMock(
            return_value={"result": "ok"}
        )
    ...
    def test_on_task_completed_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.on_task_completed = AsyncMock(
            return_value={"result": "ok"}
        )
    ...
    def test_create_process_unit(self):
        ...
        with patch(
            "src.aicrm.api.routers.automation.Process", return_value=mock_process
        ):
    ...
    def test_update_process_unit(self):
        ...
        update_data = ProcessUpdate(
            name="Updated Process", description="Updated Description"
        )
    ...
    def test_generate_automation_chain_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.generate_automation_chain_with_ai = AsyncMock(
            return_value={"success": True, "chain": {"stages": [], "robots": []}}
        )
    ...
    def test_get_execution_stats_unit(self):
        ...
        mock_analytics_service.get_execution_stats = AsyncMock(
            return_value={"total_executions": 100, "success_rate": 0.95}
        )

        with patch(
            "src.aicrm.api.routers.automation.AutomationAnalyticsService",
    ...
    def test_get_robot_performance_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_analytics_service = MagicMock()
        mock_analytics_service.get_robot_performance = AsyncMock(
            return_value={"robots": [{"id": 1, "executions": 50}]}
        )
    ...
    def test_optimize_automation_chain_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.optimize_automation_chain_with_ai = AsyncMock(
            return_value={"success": True, "optimized_chain": {"stages": []}}
        )
        ...
        with patch(
            ...
            result = optimize_automation_chain(
                1, "performance", mock_db, mock_current_user
            )
    ...
    def test_suggest_automation_improvements_unit(self):
        ...
        mock_current_user = MagicMock()
        mock_automation_service = MagicMock()
        mock_automation_service.analyze_and_suggest_improvements = AsyncMock(
            return_value={"suggestions": ["Add more robots", "Optimize triggers"]}
        )
        ...
        with patch(
            ...
            result = suggest_automation_improvements(
                None, 30, mock_db, mock_current_user
            )
