...
async def send_email(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при отправке email: {str(e)}"
        )
...
async def send_template_email(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при отправке шаблонного email: {str(e)}"
        )
...
async def test_email_config(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при отправке тестового email: {str(e)}"
        )
...
async def get_email_service_status(current_user: User = Depends(get_current_user)):
    ...
    return {
        "service": "email",
        "status": (
            "configured" if config_status["smtp_configured"] else "not_configured"
        ),
...
async def get_email_folders(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при получении папок: {str(e)}"
        )
...
async def get_email_messages(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при получении сообщений: {str(e)}"
        )


@router.post("/search", response_model=List[ReceivedEmailResponse])
async def search_emails(
    request: EmailSearchRequest, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        messages = await email_service.search_emails(
            query=request.query, folder=request.folder, limit=request.limit
        )
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при поиске сообщений: {str(e)}"
        )


@router.post("/mark-read")
async def mark_emails_as_read(
    request: EmailActionRequest, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        success = await email_service.mark_as_read(
            message_ids=request.message_ids, folder=request.folder
        )
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Не удалось отметить сообщения как прочитанные"
            )

    except Exception as e:
        raise HTTPException(
            status_code=500, detail=f"Ошибка при отметке сообщений: {str(e)}"
        )
...
async def mark_emails_as_unread(
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500,
                detail="Не удалось отметить сообщения как непрочитанные",
            )
...
async def flag_emails(
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Не удалось пометить сообщения флагом"
            )

    except Exception as e:
        raise HTTPException(
            status_code=500, detail=f"Ошибка при установке флага: {str(e)}"
        )
...
async def unflag_emails(
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Не удалось снять флаг с сообщений"
            )

    except Exception as e:
        raise HTTPException(
            status_code=500, detail=f"Ошибка при снятии флага: {str(e)}"
        )
...
async def delete_emails(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при удалении сообщений: {str(e)}"
        )


@router.post("/move")
async def move_emails(
    request: EmailMoveRequest, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        ...
        if success:
            return {
                "success": True,
                "message": f"Сообщения перемещены в папку {request.to_folder}",
            }
        else:
            raise HTTPException(
                status_code=500, detail="Не удалось переместить сообщения"
            )

    except Exception as e:
        raise HTTPException(
            status_code=500, detail=f"Ошибка при перемещении сообщений: {str(e)}"
        )
...
async def add_email_contact(
    request: EmailContactRequest, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при добавлении контакта: {str(e)}"
        )


@router.get("/contacts", response_model=List[EmailContactResponse])
async def get_email_contacts(
    search: Optional[str] = None, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при получении контактов: {str(e)}"
        )
...
async def create_email_template(
    request: EmailTemplateRequest, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при создании шаблона: {str(e)}"
        )
...
async def get_email_templates(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при получении шаблонов: {str(e)}"
        )
...
async def render_email_template(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при рендеринге шаблона: {str(e)}"
        )
...
async def get_email_settings(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при получении настроек: {str(e)}"
        )


@router.post("/settings", response_model=EmailSettingsResponse)
async def save_email_settings(
    settings_data: EmailSettingsRequest, current_user: User = Depends(get_current_user)
):
    """
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Ошибка при сохранении настроек: {str(e)}"
        )
...
async def test_smtp_connection(
    ...
    try:
        ...
        server.sendmail(
            settings_data.default_from_email,
            settings_data.default_from_email,
            msg.as_string(),
        )
