...
from ...models.automation import EntityType, Process, TriggerEvent
...
class AutomationService:
    ...
    async def on_avito_message_received(
    ...
    async def on_avito_chat_created(
    ...
    async def on_avito_chat_closed(
        self, chat_id: str, close_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Закрыт чат в Avito"""
        return await self.handle_event(
            EntityType.COMMUNICATION,
    ...
    async def generate_automation_chain_with_ai(
        ...
        try:
            ...
            generated_process = {
                ...
                "description": generated_data.get(
                    "description", "AI-generated process"
                ),
    ...
    async def analyze_and_suggest_improvements(
        self, entity_type: Optional[EntityType] = None, analysis_period_days: int = 30
    ) -> Dict[str, Any]:
        """
...
"""
    ...
    def _build_analysis_prompt(
        self, stats: Dict[str, Any], entity_type: Optional[EntityType] = None
    ) -> str:
...
"""
            ...
            for trigger_data in triggers_data:
                ...
                if target_stage_id:
                    ...
                    try:
                        ...
                        logger.warning(
                            f"Invalid event_type: {event_type_str}, skipping trigger"
                        )
                        continue
    ...
    async def _collect_automation_stats(
        self, entity_type: Optional[EntityType] = None, days: int = 30
    ) -> Dict[str, Any]:
