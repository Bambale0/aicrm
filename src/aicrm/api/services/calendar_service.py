...
class CalendarService:
    ...
    async def _send_google_invite(
        self, event_id: str, attendees: List[str], calendar_id: str
    ) -> Dict[str, Any]:
        ...
        async with httpx.AsyncClient() as client:
            ...
            for email in attendees:
                if not any(
                    att.get("email") == email for att in event_data["attendees"]
                ):
    ...
    async def _create_outlook_event(
        ...
        event_data = {
            ...
            "start": {"dateTime": start_time, "timeZone": "Russian Standard Time"},
            "end": {"dateTime": end_time, "timeZone": "Russian Standard Time"},
        }
    ...
    async def list_events(
        ...
        try:
            if provider == "google":
                ...
                return await self._list_outlook_events(
