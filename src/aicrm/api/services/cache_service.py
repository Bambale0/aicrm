...
class CacheService:
    ...
    async def set_order_data(
        self, order_id: int, data: Dict[str, Any], ttl: Optional[int] = None
    ) -> bool:
    ...
    async def set_customer_orders(
        self, customer_id: int, orders: List[Dict[str, Any]], ttl: Optional[int] = None
    ) -> bool:
    ...
    async def clear_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            if keys:
                ...
                logger.info(
                    "Cache cleared by pattern", pattern=pattern, keys_deleted=len(keys)
                )
                return len(keys)
            return 0
        except Exception as e:
