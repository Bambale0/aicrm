...
class TestTelegramApi:
    ...
    async def test_initialize_bot_success(self, async_client: AsyncClient):
        ...
        with patch("src.aicrm.services.telegram_bot_service.TelegramBotService") as mock_service_class:
    ...
    async def test_send_message_success(self, async_client: AsyncClient):
        ...
        with patch("src.aicrm.services.telegram_bot_service.TelegramBotService") as mock_service_class:
            ...
            response = await async_client.post("/telegram/send-message", json=message_data)
    ...
    async def test_get_telegram_communications_with_params(self, async_client: AsyncClient):
    ...
    async def test_link_chat_to_customer_success(self, async_client: AsyncClient):
        ...
        response = await async_client.post(f"/telegram/chat/{chat_id}/link-customer?customer_id={customer_id}")
    ...
    async def test_link_chat_to_customer_chat_not_found(self, async_client: AsyncClient):
    ...
    async def test_link_chat_to_customer_customer_not_found(self, async_client: AsyncClient):
    ...
    async def test_unlink_chat_from_customer_success(self, async_client: AsyncClient):
        ...
        response = await async_client.delete(f"/telegram/chat/{chat_id}/unlink-customer")
    ...
    async def test_telegram_webhook_initialization_failure(self, async_client: AsyncClient):
    ...
    async def test_set_webhook_success(self, async_client: AsyncClient):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            response = await async_client.post(f"/telegram/set-webhook?webhook_url={webhook_url}")
    ...
    async def test_delete_webhook_failure(self, async_client: AsyncClient):
        ...
        with patch("httpx.AsyncClient") as mock_client_class:
            ...
            mock_response = MagicMock()
            mock_response.status_code = 200
            mock_response.json.return_value = {"ok": False, "description": "Webhook not found"}
            mock_client.post.return_value = mock_response
            mock_client_class.return_value = mock_client
    ...
    async def test_send_message_validation_error_missing_fields(self, async_client: AsyncClient):
    ...
    async def test_send_message_validation_error_empty_message(self, async_client: AsyncClient):
    ...
    async def test_link_chat_validation_error_invalid_customer_id(self, async_client: AsyncClient):
    ...
    async def test_set_webhook_validation_error_invalid_url(self, async_client: AsyncClient):
        """Тест валидации - некорректный URL webhook"""
        invalid_url = "not-a-url"

        response = await async_client.post(f"/telegram/set-webhook?webhook_url={invalid_url}")
