...
class TestEmailApi:
    ...
    async def test_send_template_email_service_error(self, async_client: AsyncClient):
        ...
        with patch("src.aicrm.services.email_service.email_service") as mock_service:
            mock_service.send_template_email = MagicMock(side_effect=Exception("Template Error"))
    ...
    async def test_test_email_config_service_error(self, async_client: AsyncClient):
        ...
        with patch("src.aicrm.services.email_service.email_service") as mock_service:
            mock_service.send_email = MagicMock(side_effect=Exception("SMTP Config Error"))
    ...
    async def test_get_available_templates_unauthorized(self, async_client: AsyncClient):
    ...
    async def test_get_email_service_status_unauthorized(self, async_client: AsyncClient):
    ...
    async def test_send_email_validation_error_missing_fields(self, async_client: AsyncClient):
    ...
    async def test_send_email_validation_error_invalid_email(self, async_client: AsyncClient):
    ...
    async def test_send_template_email_validation_error(self, async_client: AsyncClient):
