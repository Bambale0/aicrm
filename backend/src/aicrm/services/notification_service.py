...
class NotificationService:
    ...
    async def send_notification(
            ...
            try:
                if channel == NotificationChannel.EMAIL:
                    result = await self._send_email_notification(
                        ...
                        subject, template_data, attachments
                    )
        ...
        return {
            ...
            "failed_channels": [k for k in results.keys() if not results[k].get("success", False)],
            "results": results,
            "errors": errors,
        ...
        try:
            ...
            if not self.telegram_service:
                if self.db_session:
                    ...
                    return {"success": False, "error": "Telegram сервис не инициализирован - отсутствует db_session"}
    ...
    def _extract_telegram_id(self, recipient: Union[str, Dict[str, str]]) -> Optional[str]:
    ...
    def _get_template_for_type(self, notification_type: NotificationType) -> Optional[str]:
    ...
    def get_notification_stats(self) -> Dict[str, Any]:
        ...
        return {
            "email_stats": self.email_service.get_email_stats() if hasattr(self.email_service, 'get_email_stats') else {},
