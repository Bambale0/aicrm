...
class SessionService:
    ...
    async def update_session_activity(self, session_id: str) -> bool:
        ...
        try:
            ...
            logger.error("Failed to update session activity", error=str(e), session_id=session_id)
            return False
    ...
    async def delete_user_sessions(self, user_id: int) -> int:
        ...
        try:
            ...
            logger.info("User sessions deleted", user_id=user_id, count=len(session_ids))
    ...
    async def get_active_sessions_count(self, user_id: int) -> int:
        ...
        async with session_service:
            ...
            try:
                ...
                logger.error("Failed to get active sessions count", error=str(e), user_id=user_id)
                return 0
