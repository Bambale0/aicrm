...
from .notification_service import NotificationService, NotificationChannel, NotificationType, NotificationPriority
...
class EventNotificationService:
    ...
    async def _handle_user_registered(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        notification_config = self.system_settings_service.get_notification_config(self.db_session)

        if notification_config.get('enabled') and notification_config.get('email_enabled'):
    ...
    async def _handle_user_login_failed(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if attempts % 5 == 0:
            ...
            security_config = self.system_settings_service.get_security_config(self.db_session)
            max_attempts = security_config.get('max_login_attempts', 5)

            priority = NotificationPriority.HIGH if attempts >= max_attempts else NotificationPriority.MEDIUM
    ...
    async def _handle_user_password_changed(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_organization_created(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        admin_message = f"Ваша организация '{org_name}' успешно создана и находится на проверке."
    ...
    async def _handle_organization_activated(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        """Обработка события активации организации"""
        org_name = event_data.get('organization_name')
        org_email = event_data.get('organization_email')

        message = f"Организация активирована: {org_name} ({org_email})"
        org_message = f"Ваша организация '{org_name}' успешно активирована и готова к работе."
    ...
    async def _handle_organization_deactivated(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_order_created(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        customer_message = f"Ваш заказ #{order_id} успешно создан. Сумма: {total_amount}"
    ...
    async def _handle_order_status_changed(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        message = f"Заказ #{order_id}: статус изменен с '{old_status}' на '{new_status}'"
    ...
    async def _handle_order_completed(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_payment_received(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        customer_message = f"Платеж на сумму {amount} за заказ #{order_id} успешно получен."
    ...
    async def _handle_task_assigned(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        message = f"Задача '{task_title}' назначена на {assignee_name}"
    ...
    async def _handle_system_error(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        message = f"Системная ошибка: {error_message} (местоположение: {error_location})"
    ...
    async def _handle_system_backup_completed(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_system_resource_high(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
