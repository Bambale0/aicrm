...
class EmailSettings(Base):
    ...
    user_id = Column(Integer, nullable=False, index=True)  # ID пользователя из user таблицы

    # SMTP настройки
    smtp_host = Column(String(255), nullable=False)
    smtp_port = Column(Integer, default=587)
    smtp_username = Column(String(255), nullable=False)
    smtp_password = Column(Text, nullable=False)  # Храним зашифрованным в реальной системе
    ...
    test_status = Column(String(50), default="not_tested")  # "not_tested", "passed", "failed"
