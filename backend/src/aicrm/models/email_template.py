...
class EmailTemplate(BaseModel):
    ...
    is_default = Column(Boolean, default=False, index=True)  # Шаблон по умолчанию для категории
        ...
        return [
            {
                ...
                Команда AI CRM
                """,
                "variables": ["order_id", "customer_name", "order_date", "total_amount", "deadline", "tracking_url", "support_phone"],
                "required_variables": ["order_id", "customer_name", "total_amount", "deadline"],
                "category": "orders",
            ...
            },
            {
                ...
                """,
                "variables": ["task_id", "task_title", "task_description", "assignee_name", "assigner_name", "priority", "priority_display", "deadline", "task_url", "support_phone"],
                "required_variables": ["task_title", "assignee_name", "task_description"],
                "category": "tasks",
            ...
            },
            {
                ...
                Команда AI CRM
                """,
                "variables": ["order_id", "customer_name", "total_amount", "payment_deadline", "payment_methods", "payment_url", "support_phone"],
                "required_variables": ["order_id", "customer_name", "total_amount", "payment_deadline"],
                "category": "payments",
            ...
            },
            {
                ...
                Команда AI CRM
                """,
                "variables": ["customer_name", "getting_started_url", "dashboard_url", "support_phone"],
