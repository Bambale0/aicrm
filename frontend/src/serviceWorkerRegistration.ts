/**
 * Service Worker Registration for AI CRM Frontend
 *
 * This module handles the registration and management of the service worker
 * for offline caching, performance optimization, and PWA functionality.
 */
...
export function trackSWPerformance() {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.addEventListener('message', (event) => {
      ...
      if (event.data && event.data.type === 'CACHE_MISS') {
